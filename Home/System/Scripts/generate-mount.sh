...
#!/bin/sh
# This script is auto generated by https://github.com/LeandroTheDev/arch_linux/blob/leansgen/Home/System/Scripts/generate-mount.sh
mkdir -p "/home/$username/System/Devices/$name"
sudo mount -o defaults,umask=000 /dev/$disk_name "/home/$username/System/Devices/$name"
EOF
